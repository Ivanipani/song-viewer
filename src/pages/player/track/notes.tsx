                  ...
                  <Stack gap="xs">
                    ...
                    {metadata.performance.improvised !== undefined && (
                      <Group gap="xs">
                        ...
                        <Text>
                          {metadata.performance.improvised ? "Yes" : "No"}
                        </Text>
                      </Group>
                    )}
                  </Stack>
              ...
              {metadata.theory && (
                <Paper p="md" withBorder>
                  ...
                  <Stack gap="sm">
                    ...
                    {metadata.theory.techniques &&
                      metadata.theory.techniques.length > 0 && (
                        <Box>
                          <Text fw={500} mb="xs">
                            Techniques:
                          </Text>
              ...
              {metadata.recording && (
                <Paper p="md" withBorder>
                  ...
                  <Stack gap="xs">
                    ...
                    {metadata.recording.effects &&
                      metadata.recording.effects.length > 0 && (
                        <Box>
                          <Text fw={500} mb="xs">
                            Effects:
                          </Text>
              ...
              {(metadata.inspiration ||
                ...
                <Paper p="md" withBorder>
                  ...
                  <Stack gap="sm">
                    ...
                    {metadata.related_tracks &&
                      metadata.related_tracks.length > 0 && (
                        <Box>
                          <Text fw={500} mb="xs">
                            Related Tracks:
                          </Text>
                          <Stack gap="xs">
                            {metadata.related_tracks.map((relatedId, idx) => {
                              const relatedTrack = catalog?.songs.find(
                                (s) => s.id === relatedId,
                              );
                              return (
                                <Text
                                ...
                                >
                                  {relatedTrack
                                    ? `${relatedTrack.title} - ${relatedTrack.artist}`
                                    : relatedId}
                                </Text>
                              );
                            })}
